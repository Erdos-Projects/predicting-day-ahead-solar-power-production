...
def dc_power_dataframe_generator(
    ...
    for metric_data_dict in my_dc_power_names:
        if metric_data_dict['whole_or_part'] == 'whole':
            ...
            raise ValueError('The "whole_or_part" result of find_all_dc_pow_metrics()\n'
...
if __name__ == '__main__':
    ...
    # append to metadata
    systems_cleaned = pd.merge(left=systems_cleaned,
                               right=all_dc_pow_metadata,
                               left_on='system_id',
                               right_index=True)
    ...
    for system_id in all_dc_pow_metrics.keys():
        ...
        # insert saving code here later, once everything is loaded
        # from all variables
