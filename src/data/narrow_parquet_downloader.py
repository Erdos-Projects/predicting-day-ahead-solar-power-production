...
add_logs = True
max_workers = 10
# short_list of systems
systems_cleaned = pd.read_csv('../../data/core/systems_cleaned.csv')
good_timezone_systems = [4, 10, 33, 36, 50, 51, 1199, 1204, 1283,
                         1284, 1289, 1332, 4902, 4903]

# 14 systems in general [temporarily indexed 0-13]
# less necessary to batch, but will do so to keep simple
i_start = 0
i_end = 13
...
def download_index_set(j_start, j_end):
    ...
    def _download_system(j):
        ...
        system_id = good_timezone_systems[j]
