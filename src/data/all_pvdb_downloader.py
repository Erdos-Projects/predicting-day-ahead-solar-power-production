...
# add logs?
add_logs = True
# 240 PVDB systems in general [temporarily indexed 0-1453]
...
pvdb_systems = systems_cleaned.loc[
    systems_cleaned.loc[:, 'system_source'] == 'PVDB'
]
pvdb_system_ids = list(pvdb_systems.system_id.unique())
